...
- QA04 validada em ambiente nativo: Android API 24 e iOS 18.5 foram compilados, instalados e executados corretamente. Node `24.16.0`, React Native `0.87.1`, Re.Pack `5.4.0-canary-20260913172854` e Rspack `1.7.12` permanecem compativeis com os requisitos conhecidos. iOS 27 fica fora do baseline atual e sera tratado como divida tecnica separada pela exigencia de adocao do lifecycle `UIScene`.
...
- QA04: baseline nativo validado em Android API 24 e iOS 18.5; a compatibilidade com iOS 27 permanece fora do baseline e depende da adocao futura do lifecycle `UIScene`.
...
- QA04 foi validada em ambiente nativo para Android API 24 e iOS 18.5. iOS 27 permanece fora do baseline atual e exige uma mudanca tecnica separada para adotar o lifecycle `UIScene`.
